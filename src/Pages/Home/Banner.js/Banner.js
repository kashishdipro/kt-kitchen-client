        ...
        <section className='my-4'>
            <div className="flex flex-col-reverse md:justify-between items-center bg-neutral-100 border rounded-lg shadow-md md:flex-row md:max-w-full hover:bg-neutral-200">
                <div className="flex flex-col p-4 leading-normal">
                    <Typography className="text-red-700 md:text-xl text-lg font-semibold">WELCOME TO MY</Typography>
                    <Typography className="text-neutral-600 md:text-5xl text-2xl font-bold md:my-4 my-2">Healthy Food Items!</Typography>
